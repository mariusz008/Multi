(function(){
	...
	var app = angular.module('guestCompetitionsController', ["ngStorage", 'ngRoute', 'naif.base64']);

    app.controller('guestCompetitionsController', ['$scope', '$http', '$log', '$sessionStorage','$route','$window', function($scope, $http, $log, $sessionStorage,$route, $window){
