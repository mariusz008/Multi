(function(){
	...
	var app = angular.module('guestStageDetailsController', ["ngStorage", 'ckeditor', 'ngRoute','uiGmapgoogle-maps']);

    app.controller('guestStageDetailsController', ['$scope', '$http', '$log', '$sessionStorage','$route', function($scope, $http, $log, $sessionStorage,$route){
